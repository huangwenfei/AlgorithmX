#
#  Be sure to run `pod spec lint AlgorithmX.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://gitee.com/windyhuangwenfei/AlgorithmX"
  ...
  spec.source       = { :git => "https://gitee.com/windyhuangwenfei/AlgorithmX.git", :tag => spec.version }
