...
public struct SingleCircleLinkedList<Element>: ListProtocol {
    
    public typealias Element = Element
    public typealias Node = SingleCircleLinkedListNode<Element>
...
extension SingleCircleLinkedList: CustomStringConvertible {
...
extension SingleCircleLinkedList {
    ...
    public mutating func push(element: Element) {
        ...
        head = .init(element: element, next: head)
    ...
    public func lastIndex(where predicate: (_ element: Element) -> Bool) -> Int? {
        ...
        var node: Node? = head
        var elements = [Element](arrayLiteral: head.element)
